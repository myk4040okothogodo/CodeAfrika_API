"""
Django settings for CodeAfrikaSchool project.
...
SECRET_KEY = 'django-insecure-3=80rf5dtxy02#7t1%2#5dv=2m!1#3u2bm)=tl#uao6qd(zs1j'
...
WSGI_APPLICATION = 'CodeAfrikaSchool.wsgi.application'
